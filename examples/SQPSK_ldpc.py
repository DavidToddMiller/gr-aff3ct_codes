...
class SQPSK_ldpc(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/davem/AFF3CT_GithubTest/gr-aff3ct_codes/examples/AllenTelescopeArray1minuteRecordingOnly_QPSK_LDPC_OrionMOON_RF_IQ', False, 0, 0)
        self.blocks_file_source_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_sink_1 = blocks.file_sink(gr.sizeof_char*1, '/home/davem/AFF3CT_GithubTest/gr-aff3ct_codes/examples/Before_LDPC_Decode_Sink', False)
        self.blocks_file_sink_1.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/davem/AFF3CT_GithubTest/gr-aff3ct_codes/examples/Test_LDPC_Sink', False)
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.digital_symbol_sync_xx_0_0_0_0, 0))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.digital_costas_loop_cc_0_0_0, 0))
