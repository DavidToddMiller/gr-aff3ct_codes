...
# Title: SQPSK_LDPC_demodulator
# Author: Original from gr-satellites
...
class sqpsk_LDPC(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "SQPSK_LDPC_demodulator", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SQPSK_LDPC_demodulator")
